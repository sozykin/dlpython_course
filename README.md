...
2. `cnn` - примеры использования сверточных нейронных сетей. 
3. `pretrained_networks` - использование предварительно обученных нейронных сетей для классификации изображений.
4. `transfer_learning` - перенос обучения (transfer learning) для классификации изображений.
