...
2. `cnn` - примеры использования сверточных нейронных сетей для классификации изображений. 
...
5. `text_processing` - основы анализа текстов с помощью нейронных сетей.
6. `rnn` - пример использования рекуррентных нейронных сетей для классификации текста.
7. `cnn1d` - пример использования одномерных сверточных нейронных сетей для классификации текста.
8. `keras_callbacks` - примеры использования callbacks в Keras.
9. `archive` - архив с устаревшими примерами.
